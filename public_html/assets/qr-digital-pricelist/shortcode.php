...
class QR_Digital_Pricelist_Shortcode {
    ...
    public static function render($atts) {
        ...
        $wallpaper  = $wallpaper !== '' ? $wallpaper : trailingslashit(QR_DIGITAL_PRICELIST_PLUGIN_URL) . 'assets/background.png';
        ...
        if ($info_text !== '') {
            ...
            $icon_url = trailingslashit(QR_DIGITAL_PRICELIST_PLUGIN_URL) . 'assets/icon-info.svg';
    ...
    private static function render_category($category, $show_disabled = false) {
        ...
        $indicator_down = esc_url(trailingslashit(QR_DIGITAL_PRICELIST_PLUGIN_URL) . 'assets/icon-arrow-down.svg');
        $indicator_up = esc_url(trailingslashit(QR_DIGITAL_PRICELIST_PLUGIN_URL) . 'assets/icon-arrow-up.svg');
        ...
        echo '<div id="' . esc_attr($content_id) . '" class="qr-digital-pricelist-items" hidden>'; 
